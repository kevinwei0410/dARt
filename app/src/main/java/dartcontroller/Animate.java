...
public class Animate {
    ...
    */
     ...
     * @param del the delta time of the animate
     * @return the Pose
     */
    ...
    public void setStartingCameraPose(Pose p){
        ...
        setGravity(StartingPose.extractRotation().inverse().rotateVector(new float[]{0f,-0.5f,0f}));
    ...
    public Pose getAnimatePose(){return AnimatePose;}
