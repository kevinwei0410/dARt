...
public class AugmentedImageRenderer {
    ...
    private final ObjectRenderer dartRenderer = new ObjectRenderer();
    private final ObjectRenderer[] imageFrames = {imageFrameUpperLeft,
            imageFrameUpperRight,
            imageFrameLowerRight,
            imageFrameLowerLeft};
    ...
    public void draw(
        ...
        Pose[] worldBoundaryPoses = new Pose[localBoundaryPoses.length];
        ...
        for (int i = 0; i != localBoundaryPoses.length; ++i) {
            ...
            imageFrames[i].updateModelMatrix(modelMatrix, scaleFactor);
            imageFrames[i].draw(viewMatrix, projectionMatrix, colorCorrectionRgba, tintColor);
        }
    }
